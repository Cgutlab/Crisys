      ...
      <div class="file-field input-field col s12 right">
        ...
        <div class="input-field col m6 s12">
          ...
          {!! Form::label('color', trans('translator.main-color').'&nbsp;&nbsp;', ['style' => 'z-index:9; background:white; border-radius: 3px 3px 0 0; width: fit-content!important;']) !!}<br />
					...
					{!! Form::select('color[]', $color, $data->color, ['class' => 'form-control', 'multiple' => 'multiple', 'style' => 'line-height: 0;']) !!}
        ...
        <div class="input-field col m6 s12">
          ...
          {!! Form::select('pttn[]', $pttn, $data->presentation, ['class' => 'form-control', 'multiple' => 'multiple', 'style' => 'line-height: 0;']) !!}

        </div>

        <div class="input-field col m6 s12">

          {!! Form::label('gmge', trans('translator.main-grammage').'&nbsp;&nbsp;', ['style' => 'z-index:9; background:white; border-radius: 3px 3px 0 0; width: fit-content!important;']) !!}<br />

          {!! Form::select('gmge[]', $gmge, $data->grammage, ['class' => 'form-control', 'multiple' => 'multiple', 'style' => 'line-height: 0;']) !!}
        ...
        <div class="input-field col m6 s12">
          ...
          {!! Form::select('size[]', $size, $data->size, ['class' => 'form-control', 'multiple' => 'multiple', 'style' => 'line-height: 0;']) !!}
